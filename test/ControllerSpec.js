...
describe("controller", function () {
  ...
  describe("routing", function () {
    ...
    it("should show active entries", function () {
      ...
      const todos = [{ title: "task still pending", completed: false, id: 3 }];

      setUpModel(todos);

      subject.setView("#/active");
      const activeRoute = subject._activeRoute;

      expect(activeRoute).toEqual("active");
    ...
    it("should show completed entries", function () {
      // TODO: write test
      const todos = [{ title: "my first to do ", completed: true, id: 1 }];
      setUpModel(todos);
      ...
      expect(activeRoute).toEqual("completed");
  ...
  it('should highlight "Active" filter when switching to active view', function () {
    // TODO: write test
    const todo = { id: 142, title: "my todo 142", completed: false };
    ...
    subject.setView("/active");
    // expect(view.render).not.toHaveBeenCalledWith("setFilter", "");
  ...
  describe("toggle all", function () {
    it("should toggle all todos to completed", function () {
      // TODO: write test
      const todos = [
        { id: 142, title: "Complete 5/9 test", completed: true },
        { id: 143, title: "Complete the rest ", completed: false },
      ];
      setUpModel(todos);
      view.render.calls.reset();
  ...
  it("should update the view", function () {
    // TODO: write test
    const todos = [
      { id: 145, title: "Complete 6 test out of 9", completed: true },
      { id: 146, title: "Complete the rest ", completed: false },
    ];
    setUpModel(todos);
    view.render.calls.reset();
    model.read.calls.reset();
  ...
  describe("new todo", function () {
    it("should add a new todo to the model", function () {
      ...
      view.trigger("newTodo", "learn more about jasmine");
      expect(model.create).toHaveBeenCalledWith("learn more about jasmine", jasmine.any(Function));
    });
  ...
  describe("element removal", function () {
    it("should remove an entry from the model", function () {
      // TODO: write test
      const todos = [{ id: 161, title: "dig deeper in mvc pattern", completed: false }];
      ...
      view.trigger("itemRemove", { id: 161 });
      expect(model.remove).toHaveBeenCalledWith(161, jasmine.any(Function));
    });
